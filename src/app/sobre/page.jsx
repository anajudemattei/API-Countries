...
export default function Home() {
    return (
        <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-300 to-pink-600 p-6">
            <div className="w-full max-w-3xl rounded-xl shadow-lg bg-gradient-to-br from-pink-200 to-pink-500 p-10 flex flex-col items-center">
                <div className="flex flex-col items-center w-full">
                                                <Image
                                                    ...
                                                    width={180}
                                                    height={180}
                                                    className="rounded-full border-4 border-pink-400 shadow-lg mb-4 mt-6 object-cover"
                                                />

                                <h2 className="text-2xl font-bold text-pink-700 mb-2 text-center">Sobre a API utilizada</h2>
                  ...
                  <h1 className="text-4xl md:text-2xl font-bold text-center mb-4">Conheça a API!</h1>
                    ...
                    <div className="flex flex-row gap-4 justify-center items-center mt-6">
                        <Link href="/">
                            <button className="bg-white hover:bg-pink-200 text-pink-700 font-medium py-2 px-6 rounded transition-colors duration-200 shadow-md border border-pink-300">
                                Voltar para a página inicial
                            </button>
                        </Link>
                        <Link href="/app/pacientes">
                            <button className="bg-pink-300 hover:bg-pink-400 text-pink-900 font-medium py-2 px-6 rounded transition-colors duration-200 shadow-md">
